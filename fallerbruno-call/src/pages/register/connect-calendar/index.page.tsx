...
export default function ConnectCalendar() {
  ...
  return (
    <>
      <NextSeo
        title="Conecte sua agenda do Google | Faller Bruno Call"
        description="Conecte sua agenda do Google e permita que as pessoas marquem agendamentos no seu tempo livre."
        noindex
      />
      <Container>
        <Header>
